...
- fictional references offer inspired, natural-character, and canon-immersive modes; public-person references remain inspiration-only and must never claim to be the real person or infer private facts
...
- a dedicated first-context step that gives equal weight to answering one lightweight personal or ordinary-life question or connecting optional user-approved data sources
