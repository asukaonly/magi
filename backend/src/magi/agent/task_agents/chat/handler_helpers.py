...
MEMORY_QUERY_GUIDANCE_BLOCK = "\n".join(
    [
        ...
        "",
        "The `query_mode` parameter is **optional** — omit it. The system auto-detects the right mode",
        "from the query content and conversation context. Only pass query_mode when explicitly overriding.",
        "",
        "Other tips:",
