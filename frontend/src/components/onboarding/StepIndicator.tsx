      ...
      {steps.map((title, index) => {
        ...
        return (
          <li
            ...
            className={cn(
              'relative flex min-h-11 min-w-[8.25rem] items-center gap-3 overflow-hidden rounded-xl px-3 transition-colors duration-200 motion-reduce:transition-none lg:min-w-0',
          ...
          >
            {active ? (
              <motion.span
                ...
                className="absolute inset-0 rounded-xl bg-accent/90 shadow-[inset_0_0_0_1px_hsl(var(--primary)/0.12)]"
