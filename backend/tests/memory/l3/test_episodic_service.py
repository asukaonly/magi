...
def test_evidence_pack_builder_caps_and_sorts():
    ...
    service = EpisodicSummaryLLMService(enabled=False, scenario_llm_pool=None)
    events = [
        {"event_id": "z", "timestamp": 30.0, "content": "third", "event_type": "T", "source": "chat_projector"},
        {"event_id": "a", "timestamp": 10.0, "content": "first", "event_type": "T", "source": "chat_projector"},
        {"event_id": "m", "timestamp": 20.0, "content": "second", "event_type": "T", "source": "chat_projector"},
    ]
    episode = {
        "episode_id": "ep",
        "episode_type": "activity",
...
def test_evidence_pack_builder_skips_missing_event_id():
    ...
    service = EpisodicSummaryLLMService(enabled=False, scenario_llm_pool=None)
    events = [
        {"event_id": "", "timestamp": 1.0, "content": "no id", "event_type": "T", "source": "chat_projector"},
        {"event_id": "good", "timestamp": 2.0, "content": "has id", "event_type": "T", "source": "chat_projector"},
    ]
    episode = {
        "episode_id": "ep2",
        "episode_type": "activity",
...
def test_evidence_pack_truncates_long_content():
    ...
    service = EpisodicSummaryLLMService(enabled=False, scenario_llm_pool=None)
    long_content = "x" * 300
    events = [{"event_id": "e1", "timestamp": 1.0, "content": long_content, "event_type": "T", "source": "chat_projector"}]
    episode = {
        "episode_id": "ep3",
        "episode_type": "activity",
        "time_start": 0.0,
...
def test_chrome_history_folded_into_summary_line():
    ...
    service = EpisodicSummaryLLMService(enabled=False, scenario_llm_pool=None)
    events = [
        {"event_id": "c1", "timestamp": 10.0, "content": "Chrome 浏览 v2ex 首页",
         "event_type": "SENSOR_EVENT", "source": "chrome_history"},
        {"event_id": "c2", "timestamp": 20.0, "content": "Chrome 浏览 Kimi 聊天页",
         "event_type": "SENSOR_EVENT", "source": "chrome_history"},
        {"event_id": "c3", "timestamp": 30.0, "content": "Chrome 浏览 v2ex 热门帖子（访问 2 次）",
         "event_type": "SENSOR_EVENT", "source": "chrome_history"},
    ]
    episode = {"episode_id": "ep", "episode_type": "activity",
               "time_start": 0.0, "time_end": 100.0,
               "primary_entity_ids": [], "primary_topic_keys": []}
    pack = service.build_episodic_evidence_pack(episode=episode, events=events)
...
def test_chat_events_stay_verbatim_with_role():
    ...
    service = EpisodicSummaryLLMService(enabled=False, scenario_llm_pool=None)
    events = [
        {"event_id": "m1", "timestamp": 10.0, "content": "我在调记忆系统",
         "event_type": "user_message", "source": "chat_projector", "author_type": 1},
        {"event_id": "m2", "timestamp": 20.0, "content": "你想看 L3 字段吗？",
         "event_type": "assistant_message", "source": "chat_projector", "author_type": 2},
    ]
    episode = {"episode_id": "ep", "episode_type": "conversation",
               "time_start": 0.0, "time_end": 100.0,
               "primary_entity_ids": [], "primary_topic_keys": []}
    pack = service.build_episodic_evidence_pack(episode=episode, events=events)
...
def test_derived_topics_from_structured_entity_hints():
    ...
    service = EpisodicSummaryLLMService(enabled=False, scenario_llm_pool=None)
    events = [
        {"event_id": "e1", "timestamp": 10.0, "content": "听歌",
         "event_type": "SENSOR_EVENT", "source": "netease_music",
         "metadata_json": _json.dumps({
             "structured_entity_hints": [
                 {"canonical_name_hint": "Summer Fizz Pop", "entity_type": "media"},
             ],
         })},
        {"event_id": "e2", "timestamp": 20.0, "content": "听歌",
         "event_type": "SENSOR_EVENT", "source": "netease_music",
         "metadata_json": _json.dumps({
             "structured_entity_hints": [
                 {"canonical_name_hint": "Summer Fizz Pop", "entity_type": "media"},
...
def test_render_user_prompt_includes_folded_and_verbatim_sections():
    ...
    service = EpisodicSummaryLLMService(enabled=False, scenario_llm_pool=None)
    events = [
        {"event_id": "c1", "timestamp": 10.0, "content": "Chrome 浏览 v2ex",
         "event_type": "SENSOR_EVENT", "source": "chrome_history"},
        {"event_id": "m1", "timestamp": 20.0, "content": "我在调记忆系统",
         "event_type": "user_message", "source": "chat_projector", "author_type": 1},
    ]
    episode = {"episode_id": "ep", "episode_type": "activity",
               "time_start": 0.0, "time_end": 100.0,
...
def test_render_user_prompt_no_folded_section_when_no_noisy_sources():
    service = EpisodicSummaryLLMService(enabled=False, scenario_llm_pool=None)
    events = [
        {"event_id": "m1", "timestamp": 10.0, "content": "hi",
         "event_type": "user_message", "source": "chat_projector", "author_type": 1},
    ]
    episode = {"episode_id": "ep", "episode_type": "activity",
               "time_start": 0.0, "time_end": 100.0,
