...
Promoted to the SDK so plugins and tools can catch these errors without
importing host internals. The host re-exports these from
magi.llm.image_generation.errors (shim) to preserve class identity.
"""
