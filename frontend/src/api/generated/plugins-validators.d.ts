...
export declare function validatePluginRegistryResponse(value: unknown): value is components['schemas']['PluginRegistryResponse'];
export declare function validatePluginInstallPlanResponse(value: unknown): value is components['schemas']['PluginInstallPlanResponse'];
