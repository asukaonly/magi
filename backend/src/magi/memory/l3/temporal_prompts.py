...
- The `content` field MUST be Markdown (GitHub-flavored). Use the `##` section headings listed in the period Structure Contract; no top-level `#` heading. Keep it compact - section bodies should be a short paragraph or a tight bulleted list, not long prose.
