"""Tests for portrait refresh scheduling after L2 assertion confirmation."""
...
async def test_feedback_route_rejects_non_confirmation_feedback(
    tmp_path: Path,
    monkeypatch,
):
    db_path = str(tmp_path / "memory.db")
