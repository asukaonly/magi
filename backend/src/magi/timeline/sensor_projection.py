"""Build the timeline read model from host-rendered sensor projections.

Relocated from ``magi.awareness.sensor_projection`` to invert the
...
*down* into awareness for the sensor output/projection inputs.
"""
...
from ..awareness.sensor_projection import SensorProjection
