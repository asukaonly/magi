...
- [ ] **Step 4: Smoke-run against one plugin with deps**
...
- [ ] **Step 6: Commit the script only (locks come in Task 2)**
...
- [ ] **Step 2: Verify each lock is non-empty and hashed**
...
- [ ] **Step 3: Verify platform-marker handling on a Windows-only dep**
...
- [ ] **Step 4: Confirm `--check` is clean across all plugins**
...
- [ ] **Step 3: Verify registry is currently in sync (so the new CI won't fail on existing state)**
...
- [ ] **Step 1: Add lockfile rules to the Do/Don't list**
...
- [ ] **Step 1: Locks deterministic, registry in sync, YAML valid**
...
- [ ] **Step 1: Read the current install internals first**
...
- [ ] **Step 4: Add constants + env-var reader near line 29**
...
- [ ] **Step 5: Replace the command builder + add the loose fallback builder**
...
- [ ] **Step 6: Add the policy helper + exception**
...
- [ ] **Step 7: Rewrite `_install_dependencies` body (line 527) to use the policy**
...
- [ ] **Step 8: Run the unit + policy tests, verify pass**
...
- [ ] **Step 1: Write an integration test that actually invokes pip with a bad hash**
...
- [ ] **Step 1: Full plugin test suite + targeted module**
...
- [ ] **Step 2: Gateway sanity (untouched, confirm no regression)**
