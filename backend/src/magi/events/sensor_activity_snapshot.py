"""Neutral activity snapshots derived from sensor event payloads."""
...
def build_sensor_activity_snapshot(
    payload: SensorEventEmitted,
    *,
    event_id: str,
) -> dict[str, Any]:
    """Build a neutral activity snapshot from sensor payload context."""
